$(function() {
    ...
    */
    ...
    $('.addTaskAccordion .collapse').on('shown.bs.collapse', function () {
        ...
        if (getClassOfAccordion === 'task-Samzyle') {
            addClassInAddTaskBtn = $(this).parents('.modal-content').find('[data-btnfn="addTask"]').addClass('task-Samzyle');
        }
    ...
    function $_taskAdd( getParent ) {
        ...
        $('[data-btnfn="addTask"]').off('click').on('click', function(event) {
            ...
            if (getAddBtnClass === 'task-Samzyle') {
                var $_task = document.getElementById('s-Samzyle-task').value;

                $html =   '<div data-draggable="true" class="card Samzyle-title-task" style="">'+
                                '<div class="card-body">'+
    ...
    function $_taskEdit() {
      $('.card .s-task-edit').off('click').on('click', function(event) {
        ...
        } else if ($(this).parents('.card').hasClass('Samzyle-title-task')) {

            var $_taskTitle = $_outerThis.parents('.card').find('h4').attr('data-taskTitle');
            var get_value_title = $('.task-Samzyle #s-Samzyle-task').val($_taskTitle);
            $('.task-Samzyle .collapse').collapse('show');
        ...
        $('[data-btnfn="editTask"]').off('click').on('click', function(event) {
            ...
            } else if ($_outerThis.parents('.card').hasClass('Samzyle-title-task')) {
